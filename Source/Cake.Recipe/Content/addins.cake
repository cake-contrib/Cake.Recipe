...
#addin nuget:?package=Portable.BouncyCastle&version=1.9.0
#addin nuget:?package=MimeKit&version=2.15.1
#addin nuget:?package=MailKit&version=2.15.0
#addin nuget:?package=MimeTypesMap&version=1.0.8
#addin nuget:?package=Cake.Email.Common&version=1.0.0
...
#load nuget:?package=Cake.Issues.Recipe&version=1.3.1
