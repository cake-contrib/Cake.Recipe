...
<html>
    <head>
        ...
        <title>Cake.Recipe - Recipe Cake</title>
    ...
    <body class="hold-transition wyam layout-boxed  ">    
        ...
        <div><p><a href="https://github.com/cake-contrib/Cake.Recipe/tree/develop/docs/input/docs/fundamentals/recipe-cake.md"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Content</a></p></div>
    <div id="infobar-headings"></div>
                ...
                <li class="selected"><a href="/Cake.Recipe/docs/fundamentals/recipe-cake.md">Recipe Cake</a></li>
