...
<html>
    <head>
        ...
        <title>Cake.Recipe - Set Tool Settings</title>
    ...
    <div id="infobar-headings"></div>
                ...
                <li class="selected"><a href="/Cake.Recipe/docs/fundamentals/set-tool-settings.md">Set Tool Settings</a></li>
