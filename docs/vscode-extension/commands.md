...
<html>
    <head>
        ...
        <title>Cake.Recipe - Commands</title>
    ...
    <body class="hold-transition wyam layout-boxed  ">    
        ...
        <div><p><a href="https://github.com/cake-contrib/Cake.Recipe/tree/develop/docs/input/docs/vscode-extension/commands.md"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Content</a></p></div>
    <div id="infobar-headings"></div>
                ...
                <li class="selected"><a href="/Cake.Recipe/docs/vscode-extension/commands.md">Commands</a></li>
