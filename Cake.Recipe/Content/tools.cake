...
private const string WyamTool = "#tool nuget:?package=Wyam&version=2.2.7";
...
private const string ReportGeneratorTool = "#tool nuget:?package=ReportGenerator&version=4.2.20";
