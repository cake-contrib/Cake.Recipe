public static class ToolSettings
{
    ...
    public static void SetToolPreprocessorDirectives(
        string codecovTool = "#tool nuget:?package=codecov&version=1.12.2",
        ...
        string reSharperTools = "#tool nuget:?package=JetBrains.ReSharper.CommandLineTools&version=2020.2.1",
        ...
        string reportGeneratorTool = "#tool nuget:?package=ReportGenerator&version=4.6.4",
        string reportUnitTool = "#tool nuget:?package=ReportUnit&version=1.2.1",
        string codecovGlobalTool = "#tool dotnet:?package=Codecov.Tool&version=1.12.2",
        ...
        string reportGeneratorGlobalTool = "#tool dotnet:?package=dotnet-reportgenerator-globaltool&version=4.6.5",
