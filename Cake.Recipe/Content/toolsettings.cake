public static class ToolSettings
{
    ...
    public static void SetToolPreprocessorDirectives(
        ...
        string reSharperTools = "#tool nuget:?package=JetBrains.ReSharper.CommandLineTools&version=2020.1.4",
        ...
        string reportGeneratorTool = "#tool nuget:?package=ReportGenerator&version=4.6.2",
