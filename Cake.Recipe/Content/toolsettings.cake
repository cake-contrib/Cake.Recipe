public static class ToolSettings
{
    ...
    public static void SetToolPreprocessorDirectives(
        ...
        string reportGeneratorTool = "#tool nuget:?package=ReportGenerator&version=4.7.0",
        ...
        string gitVersionGlobalTool = "#tool dotnet:?package=GitVersion.Tool&version=5.5.0",
        string reportGeneratorGlobalTool = "#tool dotnet:?package=dotnet-reportgenerator-globaltool&version=4.7.0",
